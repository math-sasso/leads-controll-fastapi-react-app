...
const LeadModal = ({ active, handleModal, token, id, setErrorMessage }) => {
    ...
    const handleCreateLead = async (e) => {
        ...
        if (!response.ok) {
            setErrorMessage("something messed up. When creating lead");
        } else {
            cleanFormData()
            handleModal()
        }
    ...
    return (
        <div className={`modal ${active && "is-active"}`}>
            ...
            <div className="modal-card">
                <header className="modal-card-head has-backgorund-primary-light">
                ...
                <footer className="modal-card-foot has-background-primary-light">
                    ...
                    <button className="button is-danger" onClick={handleModal}>
                        Cancel
                    </button>
                </footer>
            </div>
